        ...
        <div className="w-full max-w-lg   backdrop-blur-md shadow-xl overflow-hidden ">
          <div className="text-center">
            <div className="w-full h-60 overflow-hidden  relative">
              <div className=" absolute top-0 bottom-0 z-10 items-center justify-center flex px-14 flex-col">
              ...
              <div className="w-full h-60 inset-0 bg-primary/90 z-0 absolute" />
              <img
                src={Image10}
